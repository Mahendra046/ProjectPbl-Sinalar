                    ...
                    <div class="card-body">    
                        <table class="table table-striped mb-0">
                            ...
                            <tr>
                                <td>Nama:</td>
                                <td>
                                    <a href="#" id="inline-username" data-type="text" data-pk="1" data-title="Enter username">{{$pembelian->nama}}</a>
                                </td>
                            </tr>
                            <tr>
                                <td>Nama Divisi:</td>
                            ...
                            <tr>
                                <td>Class:</td>
                                <td>
                                    <a href="#" id="inline-username" data-type="text" data-pk="1" data-title="Enter username">{{$pembelian->class}}</a>
                                </td>
                            </tr>
                            <tr>
                                <td>Foto Barang:</td>
