                        ...
                        <div class="col-md-12 mt-5">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="{{url('admin/validasi/create')}}" class="btn btn-info float-right"><i class="fa fa-plus"></i>Tambah Data</a> </h4>
                                </div><!--end card-header-->
                                <div class="card-body">
                                            ...
                                            <tbody>
                                             @foreach($list_pembelian as $pembelian)
                                              <tr>
                                                ...
                                                <td><span class="badge badge-soft-danger menu-arrow">perlu validasi</span></td>
                                                <td class="text-right">
                                                    <a href="{{url('admin/validasi', $pembelian->id)}}" class="btn btn-dark"><i class="fa fa-info"></i></a>
                                                    <a href="{{url('pembelian', $pembelian->id)}}/edit" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                                    @include('template.utils.delete', ['url'=>url('pembelian', $pembelian->id)])
                                                </td>
                                              </tr>
                                             @endforeach
                                            </tbody>
